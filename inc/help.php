...
function fordummies_enqueue_scripts() {
        ...
        wp_register_script( 'theme-fix-config-manager',FORDUMMIESURL.'/js/fix-config-manager.js' , array( 'jquery' ), FORDUMMIESVERSION, true );
    	wp_enqueue_script( 'theme-fix-config-manager' );
